...
"""
#       TODO: iteration 1: [ 3, 4, 1, 2 ], iteration 2: [ 3, 1, 4, 2 ], iteration 3: [ 1, 3, 4, 2 ], iteration 4: [ 1, 3, 2, 4 ], iteration 5: [ 1, 2, 3, 4 ],  
"""
...
def my_sort(lst):
    count = 0
    lst_sorted = list(lst).copy()
    while True:
        # raise Exception("iteraties, print en veranderingen weg halen en functie call")
        try:
            for i in range(len(lst_sorted) + 1):
                if lst_sorted[count + 1]:
                    new = lst_sorted[count + 1]  
                    old = lst_sorted[count]        
                    if lst_sorted[count] > lst_sorted[count+1]: 
                        new = lst_sorted[count]
                        old = lst_sorted[count + 1]
                        lst_sorted[count + 1]  = new
                        lst_sorted[count] = old   
                        count = 0
                    else: count = count + 1
        except:
            break
...
"""
#           TODO: best case: [1,2,3]:  3 iteraties, 0 veranderingen
"""
...
"""
#           TODO: worst case: [3, 2, 1]: 7 iteraties, 3 veranderingen. 
"""
        ...
        -   Stel je hebt een lijst met de waarden 1 tot en met 4.
            ...
            Hoeveel vergelijkingen zijn er nodig?
"""
#           TODO: best case scenario: [1,2,3,4]: 4 iteraties, 0 veranderingen. 
#               Worst case scenario: [4,3,2,1]: 14 iteraties, 6 veranderingen
"""
...
"""
#raise Exception('Fout: linear_search_recursive([2, 1, 15, 19, 17, 11], 17) geeft False in plaats van True')
def linear_search_recursive(lst: list, target: int):
    # allow = False
    # if len(lst) > 0:
    #     if lst[0] == target:
    #             allow = True
    ...
    #     else:
    #         if allow == False:          
    #             linear_search_recursive(lst[1:], target)
    #             return False
